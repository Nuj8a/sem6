  ...
  return (
    ...
    >
      ...
      >
        ...
        <CardFooter className="!rounded-none group-hover:bg-[#ffefef] duration-200 shadow-inner text-small h-[60px] absolute z-20 bg-[#f4fffe] text-black/90 bottom-0 justify-between">
